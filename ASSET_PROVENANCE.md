# Provenienza degli asset visivi

Il sistema di cornici materiche del sito deriva da asset locali del progetto Computational-Physics, nella sezione `Args/Phy/MQ`.

| Asset web | Sorgente nel progetto | Uso pubblico |
|---|---|---|
